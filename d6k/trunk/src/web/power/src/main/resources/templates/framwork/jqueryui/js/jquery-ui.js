...
$.widget( "ui.spinner", {
	...
	_create: function() {
		...
		this._setOption( "target", this.options.otarget );
	...
	_spin: function( step, event ) {
		...
		if ( !this.spinning || this._trigger( "spin", event, { value: value } ) !== false ) {
			this._value( value );
			if(this.element.attr("id") == "drawtext2"){
				$("#myDivDraw").css("width",value.toString()+"px")
			}
			if(this.element.attr("id") == "drawtext3"){
				$("#myDivDraw").css("height",value.toString()+"px")
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext3"){
				this.options.otarget.css("font-size",value.toString()+"px")
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext5"){
				this.options.otarget.css("border-width",value.toString()+"px");
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext7_2"){
				this.options.otarget.css("height",value.toString()+"px");
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext7_1"){
				this.options.otarget.css("width",value.toString()+"px");
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext8"){
                var svalue = value/100;
                var h = this.options.otarget.height();
                var w = this.options.otarget.width();
				if(this.options.otarget.hasClass("myclock")){
					this.options.otarget.css("transform","scale("+svalue+","+svalue+")");
				}else{
                    this.options.otarget.height(h * svalue);
                    this.options.otarget.width(w * svalue);
				}
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext9_1"){
				this.options.otarget.css({"left":value.toString()+"px"});
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext9_2"){
				this.options.otarget.css({"top":value.toString()+"px"});
			}
			if(this.options.otarget != null & this.element.attr("id") == "edittext10"){
				this.options.otarget.css({"z-index":value.toString()});
			}
			this.counter++;
		}
	},
