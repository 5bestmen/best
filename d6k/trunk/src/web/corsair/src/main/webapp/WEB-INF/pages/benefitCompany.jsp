...
<%--<div id="wrapper">
  ...
  <div id="page-wrapper">--%>
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header">企业电费结算</h3>
      </div>
    </div>
    <div class="row">
      <div style="text-align:left; padding-bottom:5px; width: 80%">
        <form:form cssClass="form-horizontal" action="benefitCompany" method="post" commandName="benefitCompanyForm">
        ...
        <div class="col-lg-12 col-md-12">
          <div class="table-responsive">
            <table id="targetTable" class="table table-bordered table-striped" style="text-align: center">
              <tr style="text-align: center;background-color: #b4c8d8;" >
                <td colspan="6" style="text-align: center;" class="gray-bg"><h4><strong>${initDate}${stationName}企业电费结算单</strong></h4></td>
              </tr>
              <tr >
                <td>抄表日期</td>
              ...
              <c:forEach items="${totalElectricList}" var="ElectricPSR" varStatus="j">
                <tr>
                  <c:if test="${j.count == 1}">
                    <td rowspan="${fn:length(totalElectricList)}" style="vertical-align:middle">并网柜计量表</td>
                  </c:if>
              ...
              <tr >
                <td rowspan="${3 + fn:length(totalElectricList)}" style="vertical-align:middle;" class="table-head Electric-color">合计自用电量</td>
                <td>电表编码</td>
                <td>电量（kWh）</td>
