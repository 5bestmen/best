...
<head>
    ...
    <title>${sessionScope.APP_NAME}-显示模板</title>
...
<%--<div id="wrapper">
    ...
    <div id="page-wrapper">--%>
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">显示模板</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->

        <form:form cssClass="form-inline" action="displayTemplate" method="post" commandName="displayTemplateForm">
            ...
            <a class="btn btn-primary" href="displayTemplateModify">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <c:if test="${not empty displayTemplateList}">
                                <c:forEach items="${displayTemplateList}" var="display">
                                    <tr>
                                        <td>
                                            <c:out value="${display.name }"/>
                                        </td>
                                        <td>
                                            <c:out value="${display.desc }"/>
                                        </td>
                                        <td>
                                            <c:out value="${display.deviceTemplate.desc }"/>
                                        </td>
                                        <td>
                                            <c:out value="${display.displayArea.comments }"/>
                                        </td>
                                        <td align="center">
                                            <a href="displayTemplateModify?id=${display.id }">
                                        ...
                                        <td align="center">
                                            <a href="displayTemplateData?id=${display.id }">
                                        ...
                                        <td align="center">
                                            <c:if test="${account.username ne 'admin'}">
                                                <a
                                                   href="javascript:if(confirm('是否确定删除这条记录？')){document.forms[0].deleteIds.value='${display.id}';document.forms[0].del.click();}">
