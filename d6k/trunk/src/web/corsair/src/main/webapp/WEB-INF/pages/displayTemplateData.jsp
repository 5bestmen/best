...
<head>
    ...
    <title>${sessionScope.APP_NAME}-显示模板数据</title>
...
<%--<div id="wrapper">
    ...
    <div id="page-wrapper">--%>
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">${titleDesc}模板数据</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->

        <form:form cssClass="form-inline" action="displayTemplateData" method="post" commandName="displayTemplateDataForm">
            ...
            <%--<button type="submit" class="btn btn-primary">--%>
                ...
                <%--查询数据--%>
            <%--</button>--%>
            <a class="btn btn-primary" href="displayTemplateDataModify">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <c:if test="${not empty displayTemplateDataList}">
                                <c:forEach items="${displayTemplateDataList}" var="data">
                                    <tr >
                                        <td>
                                        ...
                                        <td>
                                            <c:out value="${data.extraString1 }"/>
                                        </td>
                                        <td>
                                            <c:out value="${data.extraString2 }"/>
                                        </td>
                                        <td>
                                            <c:out value="${data.extraString3 }"/>
                                        </td>
                                        <td>
                                            <c:out value="${data.deviceTemplateData.desc }"/>
                                        </td>
                                        <td align="center">
                                            <a href="displayTemplateDataModify?id=${data.id }">
