...
CComboxDelegate::CComboxDelegate(QVector<ID_DESC>& vecIdDesc, QObject *parent /*= 0*/) : m_vecAnalogCombo(vecIdDesc), QItemDelegate(parent)
{
...
void CComboxDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const
{
    ...
    QVector<ID_DESC>::const_iterator ite = m_vecAnalogCombo.constBegin();
