...
#define  M_APPLICATION      QStringLiteral("应用")
// 左边树形结构场景起始名称
#define M_SCENE_NAME	    QStringLiteral("请输入应用")
// 左边树形结构组起始名称
...
#define M_NEW_NAME               QStringLiteral("输入名称")
#define M_NEW_DESCRIBE           QStringLiteral("输入描述")
