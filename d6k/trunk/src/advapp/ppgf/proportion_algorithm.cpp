...
/*! \fn CProportionAlgorithm::CProportionAlgorithm()
********************************************************************************************************************************
** \brief   CProportionAlgorithm::CProportionAlgorithm()
** \details 
** \return 
** \author  GuoHaijun
** \date    2017年5月27日
...
/*! \fn void CProportionAlgorithm::InsertWeatherType4h(QMap<Weather_Type, Weather_Predict_Data> & map, Weather_Type type)
********************************************************************************************************************************
** \brief    CProportionAlgorithm::InsertWeatherType4h
** \details
** \return   void
** \author   GuoHaijun
** \date     2017年5月27日
...
/*! \fn void CProportionAlgorithm::InsertWeatherType4h(QMap<Weather_Type, Weather_Predict_Data> & map, QList<Weather_Type> listType)
********************************************************************************************************************************
** \brief    CProportionAlgorithm::InsertWeatherType4h
** \details
** \return   void
...
/*! \fn void CProportionAlgorithm::InsetWeatherType72h(QMap<Weather_Type, Weather_Predict_Data> & map, Weather_Type type)
********************************************************************************************************************************
** \brief    CProportionAlgorithm::InsetWeatherType72h
** \details
** \return   void
** \author   GuoHaijun
** \date     2017年5月27日
...
/*! \fn void CProportionAlgorithm::InsetWeatherType72h(QMap<Weather_Type, Weather_Predict_Data> & map, QList<Weather_Type> listType)
********************************************************************************************************************************
** \brief    CProportionAlgorithm::InsetWeatherType72h
** \details
** \return   void
