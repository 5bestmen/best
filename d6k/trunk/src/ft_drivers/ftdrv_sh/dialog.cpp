...
CShDialog::CShDialog(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CShDialog)
{
    ui->setupUi(this);
	...
	setWindowIcon(QIcon(":/rc/shell.png"));
}
...
void CShDialog::on_btn_start_clicked()
{
...
void CShDialog::on_BtnGetFilePath()
{
...
void CShDialog::on_BtnAlarmView()
{
	if (m_szFilePath.isNull())
	{
		QMessageBox::information(this, tr("Error"), tr("File Path is Empty"));
...
** \note 
********************************************************************************************************/
void CShDialog::InitComView()
{
	QFile file("appsh.xml");
...
void CShDialog::on_ComChannged(int nIndex)
{
	Q_UNUSED(nIndex);
	m_szFilePath = m_pLineEdit->text();
}

/*! \fn bool CShDialog::IsFileHasAdded(const QString& szName)
********************************************************************************************************* 
...
** \note 
********************************************************************************************************/
bool CShDialog::IsFileHasAdded(const QString& szName)
{
	for (auto i:m_FileInfoQue)
	{
