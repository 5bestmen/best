...
CForwardingDISelectDataModel::CForwardingDISelectDataModel(QObject *parent, Config::CDevice *pDevice)
...
CForwardingDISelectDataModel::~CForwardingDISelectDataModel()
{

}

void CForwardingDISelectDataModel::SetHorizontalHeaderList(QStringList list)
{
...
void CForwardingDISelectDataModel::SetVerticalHeaderList(QStringList verticalHeaderList)
{
	//vertical_header_list = verticalHeaderList;
}

int CForwardingDISelectDataModel::rowCount(const QModelIndex &parent) const
{
...
int CForwardingDISelectDataModel::columnCount(const QModelIndex &parent) const
{	
	Q_UNUSED(parent);
...
QVariant CForwardingDISelectDataModel::data(const QModelIndex &index, int role) const
{
	if (!index.isValid())
		return QVariant();
...
QVariant CForwardingDISelectDataModel::headerData(int section, Qt::Orientation orientation, int role) const
{
	if (role == Qt::DisplayRole)
	{
...
Qt::ItemFlags CForwardingDISelectDataModel::flags(const QModelIndex &index) const
{
	if (!index.isValid())
...
void CForwardingDISelectDataModel::emitDataChanged(const QModelIndex &index)
{
...
** \note 
********************************************************************************************************/
void CForwardingDISelectDataModel::InitPara()
{
	horizontal_header_list.clear();
...
void CForwardingDISelectDataModel::RefrushModel()
{
	beginResetModel();
	endResetModel();
}