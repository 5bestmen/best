...
class CChannelModel : public QAbstractTableModel
{
	Q_OBJECT
...
public:
	CChannelModel(QObject *parent, QStringList headerList, Config::CChannelData *pChannel, CQuoteItem *pItem, Config::CFesData *pfesData, IMainModuleInterface *pCore);
	~CChannelModel();
	...
	Config::CChannelData *GetChannelData();
