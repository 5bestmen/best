...
** \note 
********************************************************************************************************/
CForwardingChannelModel::CForwardingChannelModel(QObject *parent, Config::CForwardingChannelData *pChannel, CQuoteItem *pItem, Config::CFesData *pFes, IMainModuleInterface *pCore)
...
** \note 
********************************************************************************************************/
CForwardingChannelModel::~CForwardingChannelModel()
{
	arr_row_list.clear();
}
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::SetHorizontalHeaderList(QStringList list)
{
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::SetVerticalHeaderList(QStringList verticalHeaderList)
{
...
** \note 
********************************************************************************************************/
int CForwardingChannelModel::rowCount(const QModelIndex &parent) const
{
	Q_UNUSED(parent);
...
** \note 
********************************************************************************************************/
int CForwardingChannelModel::columnCount(const QModelIndex &parent) const
{	
	Q_UNUSED(parent);
...
** \note 
********************************************************************************************************/
QVariant CForwardingChannelModel::data(const QModelIndex &index, int role) const
{
	if (!index.isValid())
		return QVariant();
...
** \note 
********************************************************************************************************/
QVariant CForwardingChannelModel::headerData(int section, Qt::Orientation orientation, int role) const
{	
...
** \note 
********************************************************************************************************/
Qt::ItemFlags CForwardingChannelModel::flags(const QModelIndex &index) const
{
	if (!index.isValid())
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::SetModalDatas(QList< QVector<QString> > &rowlist)
{
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::RefrushModel()
{
	beginResetModel();
	endResetModel();
...
** \note 
********************************************************************************************************/
bool CForwardingChannelModel::setData(const QModelIndex &index, const QVariant &value, int role /* = Qt::EditRole */)
{	
	...
	{	
		if (index.column() == TagName)
		{
			...
			{
				int nSize = (int)value.toString().size();
				if (nSize > MAX_TAGNAME_LEN_SCADASTUDIO || nSize == 0)
				{
					return false;
				}
				...
				if (bFlag)
				{	
					auto strError = QString("%1 %2 is exist").arg(tr("Forwarding channel tag name:")).arg(value.toString());
		...
		else if (index.column() == ChannelName)
		{
			...
			{
				int nSize = (int)value.toString().size();
				if (nSize > MAX_NAME_LENGTH_SCADASTUDIO || nSize == 0)
				{
					return false;
				}
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::sort(int column, Qt::SortOrder order/* = Qt::AscendingOrder */)
{
	g_column = column;
...
** \note 
********************************************************************************************************/
QList<QVector<QString>> &CForwardingChannelModel::GetDataList()
{
	return arr_row_list;
}
...
** \note 
********************************************************************************************************/
bool CForwardingChannelModel::InsertRows(int position, int rows, const QModelIndex &parent)
{
...
** \note 
********************************************************************************************************/
bool CForwardingChannelModel::RemoveRows(int position, int rows, const QModelIndex &parent)
{
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::emitDataChanged(const QModelIndex &index)
{ 
...
** \note 
********************************************************************************************************/
QUndoStack *CForwardingChannelModel::undoStackTest()
{ 
	return m_stack;
}
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::SaveDataModel(QString tableName)
{
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::AddRowModel(QVector<QString> &rowList, int rowType)
{
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::GetColumInfo(QMap<QString, QString> &desc2RealField)
{
...
** \note 
********************************************************************************************************/
void CForwardingChannelModel::RemoveRowModel(QVector<QString> &rowList, int rowType)
{
	Q_UNUSED(rowList);
	Q_UNUSED(rowType);
...
void CForwardingChannelModel::InitPara()
{
	m_arrInfo.clear();
...
void CForwardingChannelModel::OnClickedView(const QModelIndex &index)
{
	Q_UNUSED(index);
}

QMap<int32s, CONFIG_PARA> & CForwardingChannelModel::GetColumnInfo()
{
	return m_arrInfo;
}

Config::CForwardingChannelData *CForwardingChannelModel::GetChannelData()
{
	Q_ASSERT(m_pChannel);
...
QVector<IDDESC>& CForwardingChannelModel::GetDriverName()
{
	return m_arrDriverName;
}

QVector<IDDESC>& CForwardingChannelModel::GetDriverPara101()
{
	return m_arrDriverPara101;
}

QVector<IDDESC>& CForwardingChannelModel::GetDriverPara104()
{
	return m_arrDriverPara104;
}

QVector<IDDESC>& CForwardingChannelModel::GetDriverParaModbus()
{
	return m_arrDriverParaModbus;
}

QVector<IDDESC> &CForwardingChannelModel::GetMedium()
{
	return m_arrMedium;
}

QVector<IDDESC> &CForwardingChannelModel::GetCOM()
{
	return m_arrCOM;
}

QVector<IDDESC> &CForwardingChannelModel::GetBaud()
{
	return m_arrBaud;
}

CQuoteItem *CForwardingChannelModel::GetCurrentTreeItem()
{
	Q_ASSERT(m_pItem);
