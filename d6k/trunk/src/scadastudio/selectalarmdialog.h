#ifndef SELECTALARMDIALOG_H
#define SELECTALARMDIALOG_H

#include <QDialog>
#include "ui_selectalarmdialog.h"
...
class CSelectAlarmDialog : public QDialog
{
	Q_OBJECT
...
public:
	CSelectAlarmDialog(QWidget *parent, Config::CFesData *pFes, void *pData, int nType);
	~CSelectAlarmDialog();
