...
class CForwardingDISelectDataModel : public QAbstractTableModel
{
	Q_OBJECT
...
public:
	CForwardingDISelectDataModel(QObject *parent, Config::CDevice *pDevice);
	~CForwardingDISelectDataModel();
