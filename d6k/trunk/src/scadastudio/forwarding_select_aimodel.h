...
class CForwardingAISelectDataModel : public QAbstractTableModel
{
	Q_OBJECT
...
public:
	CForwardingAISelectDataModel(QObject *parent, Config::CDevice *pDevice);
	~CForwardingAISelectDataModel();
