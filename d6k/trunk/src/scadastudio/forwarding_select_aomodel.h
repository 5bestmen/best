...
class CForwardingAOSelectDataModel : public QAbstractTableModel
{
	Q_OBJECT
...
public:
	CForwardingAOSelectDataModel(QObject *parent, Config::CDevice *pDevice);
	~CForwardingAOSelectDataModel();
