...
CCaptureMsgWgt * CMainModule::GetCaptureWidget()
{
    return CCaptureMsgWgt::GetInstance();
}

QTreeWidget * CMainModule::GetDetailMsgWgt()
{
    return CCaptureMsgWgt::GetInstance()->GetDetailTreeWgt();
}
