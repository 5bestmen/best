...
//	setWindowTitle(tr("Maintenance Tool"));
	...
	qApp->setWindowIcon(QIcon(":/icons/devicestudio.png"));
	CreateMenus();
	CreateLeftTree();
...
{
	QMessageBox::information(this, tr("About"), tr("DeviceStuidio, V1.0"));
}
