...
public:
	...
	bool ModifyFesBigTagName(const QString &strBigTagName, const QString &strLastBigTagName);
	bool ModifyScadaVaraibleBigTagName(const QString &strBigTagName, const QString &strLastBigTagName);
